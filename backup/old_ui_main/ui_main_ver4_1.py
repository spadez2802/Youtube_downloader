...
"}")
        ...
        self.horizontalLayout_4.setContentsMargins(0, 0, 20, 9)
...
"}")
        ...
        self.downloadBtn = QPushButton(self.linkContentWidget)
...
"}")
        ...
        self.downloadAllBtn = QPushButton(self.sideBarWidget)
...
"")
        ...
        self.verticalLayout_4.addWidget(self.downloadAllBtn, 0, Qt.AlignmentFlag.AlignHCenter)

        self.scrollArea = QScrollArea(self.sideBarWidget)
        self.scrollArea.setObjectName(u"scrollArea")
        sizePolicy.setHeightForWidth(self.scrollArea.sizePolicy().hasHeightForWidth())
        self.scrollArea.setSizePolicy(sizePolicy)
        self.scrollArea.setMinimumSize(QSize(500, 850))
        self.scrollArea.setMaximumSize(QSize(500, 850))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.downloadAllBtn.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
    # retranslateUi
