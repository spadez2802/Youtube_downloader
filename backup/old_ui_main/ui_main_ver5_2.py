...
"")
        ...
        self.sideBarWidget.setMinimumSize(QSize(450, 400))
...
"}")
        ...
        self.scrollArea.setMinimumSize(QSize(400, 600))
        self.scrollArea.setMaximumSize(QSize(500, 800))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 400, 584))
        ...
        self.scrollAreaWidgetContents.setMinimumSize(QSize(400, 400))
