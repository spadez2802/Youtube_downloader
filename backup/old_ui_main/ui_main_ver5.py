...
################################################################################
## Form generated from reading UI file 'of_newui.ui'
##
...
"}")
        ...
        self.centralwidget.setMinimumSize(QSize(1200, 1000))
...
"}")
        ...
        self.widget_3.setMinimumSize(QSize(650, 600))
...
"}")
        ...
        self.verticalLayout_2.addWidget(self.label, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
...
"")
        ...
        self.verticalLayout_6.addWidget(self.enterPlace, 0, Qt.AlignmentFlag.AlignTop)

        self.listWidget = QListWidget(self.widget_6)
        self.listWidget.setObjectName(u"listWidget")
        self.listWidget.setMinimumSize(QSize(450, 60))
...
"")
        ...
        sizePolicy.setHeightForWidth(self.comboBoxDownloadQuality.sizePolicy().hasHeightForWidth())
        self.comboBoxDownloadQuality.setSizePolicy(sizePolicy)
        self.comboBoxDownloadQuality.setMinimumSize(QSize(100, 40))
        self.comboBoxDownloadQuality.setMaximumSize(QSize(100, 40))
...
"}")
        ...
        self.sideBarWidget.setMinimumSize(QSize(550, 1000))
        self.sideBarWidget.setMaximumSize(QSize(550, 1000))
...
"}")
        ...
        self.widget_5 = QWidget(self.sideBarWidget)
        self.widget_5.setObjectName(u"widget_5")
        self.widget_5.setMinimumSize(QSize(550, 50))
        ...
        self.downloadAllBtn.setMinimumSize(QSize(200, 40))
...
"")
        ...
        self.comboBoxDownloadAllOpt.setMinimumSize(QSize(200, 40))
...
"}")
        ...
        self.widget_7 = QWidget(self.sideBarWidget)
        ...
        self.scrollArea.setMinimumSize(QSize(500, 800))
        self.scrollArea.setMaximumSize(QSize(500, 800))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 500, 800))
        self.scrollAreaWidgetContents.setMinimumSize(QSize(500, 800))
        self.scrollAreaWidgetContents.setMaximumSize(QSize(500, 800))
...
"}")
        ...
        self.verticalLayout_4.addWidget(self.scrollArea, 0, Qt.AlignmentFlag.AlignHCenter)


        self.horizontalLayout_2.addWidget(self.sideBarWidget)
