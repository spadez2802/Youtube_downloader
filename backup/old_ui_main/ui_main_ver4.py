...
"")
        ...
        self.sideBarWidget.setMinimumSize(QSize(350, 800))
        self.sideBarWidget.setMaximumSize(QSize(350, 800))
...
"")
        ...
        self.scrollArea.setMinimumSize(QSize(300, 650))
        self.scrollArea.setMaximumSize(QSize(300, 650))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 300, 600))
        self.scrollAreaWidgetContents.setMinimumSize(QSize(300, 600))
        self.scrollAreaWidgetContents.setMaximumSize(QSize(300, 600))
