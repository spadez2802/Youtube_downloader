...
"}")
        ...
        self.enterPlace = QLineEdit(self.widget)
...
"")
        ...
        self.verticalLayout_2.addWidget(self.enterPlace, 0, Qt.AlignmentFlag.AlignHCenter)
...
"}")
        ...
        self.videoImg.setMaximumSize(QSize(175, 125))
        ...
        self.videoName.setMaximumSize(QSize(200, 100))
        font = QFont()
...
"")
        ...
        self.horizontalLayout_3.addWidget(self.downloadBtn, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
