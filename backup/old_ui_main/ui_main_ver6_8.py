...
"}")
        ...
        self.verticalLayout_4.addWidget(self.widget_5, 0, Qt.AlignmentFlag.AlignTop)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 54, 211))
...
"}")
        ...
        self.verticalLayout_4.addWidget(self.scrollArea, 0, Qt.AlignmentFlag.AlignLeft)
